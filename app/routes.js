...
//middleware that will verify whether user is logged in. It will be added outside module.exports
...
module.exports = function(app, passport) {
  ...
  // Redirecting FB button click to Facebook API
  ...
  connectRouter.get('/linkedin', passport.authorize('linkedin'));
